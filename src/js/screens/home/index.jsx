...
import { SearchBar, CheckoutBanner } from "../../components/UI/molecules";
...
const SearchFeed = props => {
  return (
    ...
    >
      ...
      <CheckoutBanner
        isVisible={true}
        onClick={e => this.props.history.push("/cart")}
      />
    </Flex>
  );
};
    ...
    return (
      !this.props.app.isLoading && (
        <Flex
          style={{
            minHeight: "100vh",
            marginBottom: this.props.cart.items.length > 0 ? "140px" : "70px"
          }}
          my={4}
        ...
        >
          ...
          <CheckoutBanner
            isVisible={this.props.cart.items.length > 0}
            onClick={e => this.props.history.push("/cart")}
          />
        </Flex>
      )
